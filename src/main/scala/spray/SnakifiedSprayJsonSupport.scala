 ...
 *
 * Humbly taken from https://gist.github.com/agemooij/7679130
 *
 * Thank you @agemooij and @asnare!
 */
trait SnakifiedSprayJsonSupport extends DefaultJsonProtocol {
  import reflect._

  /**
   * Overrides the default naming scheme used by spray-json and replaces it with a scheme that turns camelcased
